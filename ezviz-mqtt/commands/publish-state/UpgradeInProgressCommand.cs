...
namespace ezviz_mqtt.commands.publish_state
{
    ...
    {
        public UpgradeInProgressCommand(TopicExtensions topics, BooleanConvertor booleanConverter, IMqttHandler mqttHandler,   IEzvizClient client) : base(topics, booleanConverter, mqttHandler, client)
        {
        }
